...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@Bots24x7"))
        else:
            ...
            await client.join_chat("𝟐𝟒𝐱𝟕 𝐁𝐎𝐓𝐒")
    except KeyError:
        pass
    try:
